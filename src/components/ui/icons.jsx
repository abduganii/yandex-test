...
export const RightIcons = () => {
    return(
        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
        <path d="M4.16669 9.99984H15.8334M15.8334 9.99984L10 4.1665M15.8334 9.99984L10 15.8332" stroke="white" stroke-width="1.66667" stroke-linecap="round" stroke-linejoin="round"/>
        </svg>
    )
}
export const LeftIcons = () => {
    return(
        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
        <path d="M15.8334 9.99984H4.16669M4.16669 9.99984L10 15.8332M4.16669 9.99984L10 4.1665" stroke="white" stroke-width="1.66667" stroke-linecap="round" stroke-linejoin="round"/>
        </svg>
    )
}
...
<path d="M7.16669 13.3333L10.5 10M10.5 10L13.8334 13.3333M10.5 10V17.5M17.1667 13.9524C18.1846 13.1117 18.8334 11.8399 18.8334 10.4167C18.8334 7.88536 16.7813 5.83333 14.25 5.83333C14.0679 5.83333 13.8976 5.73833 13.8051 5.58145C12.7184 3.73736 10.712 2.5 8.41669 2.5C4.96491 2.5 2.16669 5.29822 2.16669 8.75C2.16669 10.4718 2.86289 12.0309 3.98914 13.1613" stroke="#CECFD2" stroke-width="1.66667" stroke-linecap="round" stroke-linejoin="round"/>
</svg>
  )
}
...
export const DoneIcons= () => {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
        <path d="M7.5 12L10.5 15L16.5 9M22 12C22 17.5228 17.5228 22 12 22C6.47715 22 2 17.5228 2 12C2 6.47715 6.47715 2 12 2C17.5228 2 22 6.47715 22 12Z" stroke="#ABEFC6" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
        </svg>
    )
}
